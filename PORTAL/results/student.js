...
"Desmond Amanda": {
  ...
  "Piama Isikpi": {
    ...
    subjects: [
      ...
      { name: "Social Studies", test1: 17, test2: 18, exam: 45, total: 80, grade: "A2", remark: "Very Good" },
      { name: "History", test1: 16, test2: 17, exam: 30, total: 62, grade: "D", remark: "Pass" },
      { name: "Phonics", test1: 18, test2: 19, exam: 30, total: 67, grade: "C", remark: "Credit" },
      { name: "pre-vocational Studies", test1: 18, test2: 19, exam: 30, total: 67, grade: "C", remark: "Credit" },
      { name: "Music", test1: 19, test2: 20, exam: 30, total: 69, grade: "C", remark: "Credit" },
      { name: "Fine Arts", test1: 17, test2: 18, exam: 36, total: 71, grade: "B", remark: "Good" },
      { name: "Basic Technology", test1: 15, test2: 16, exam: 30, total: 59, grade: "D", remark: "Pass" },
      { name: "Computer Studies", test1: 16, test2: 17, exam: 30, total: 59, grade: "D", remark: "Pass" },
      { name: "Basic Science", test1: 18, test2: 19, exam: 38, total: 75, grade: "B", remark: "Good" },
      { name: "Civic Education", test1: 15, test2: 13, exam: 35, total: 63, grade: "C", remark: "Credit" },
      { name: "Literature", test1: 16, test2: 17, exam: 30, total: 62, grade: "C", remark: "Credit" },
      { name: "Business Studies", test1: 13, test2: 16, exam: 39, total: 68, grade: "C", remark: "Credit" },
      { name: "Christian Religious Studies", test1: 19, test2: 20, exam: 41, total: 80, grade: "A2", remark: "Very Good" }
    ],
    formTeacherRemark: "Piama is an excellent student but needs to improve in is neatness!",
  ...
  "Gift Forcebray": {
    ...
    average: "78.33",
    subjects: [
      { name: "English Language", test1: 16, test2: 17, exam: 55, total: 88, grade: "A2", remark: "Very Good" },
      { name: "Mathematics", test1: 15, test2: 16, exam: 40, total: 71, grade: "B", remark: "Good" },
      { name: "Social Studies", test1: 16, test2: 17, exam: 40, total: 73, grade: "B", remark: "Good" },
      { name: "History", test1: 15, test2: 16, exam: 33, total: 64, grade: "C", remark: "Credit" },
      { name: "Phonics", test1: 17, test2: 18, exam: 35, total: 70, grade: "B", remark: "Good" },
      { name: "Agricultural Science", test1: 17, test2: 18, exam: 30, total: 65, grade: "C", remark: "Credit" },
      { name: "Home Economics", test1: 17, test2: 18, exam: 25, total: 60, grade: "C", remark: "Credit" },
      { name: "Music", test1: 18, test2: 19, exam: 40, total: 77, grade: "B", remark: "Good" },
      { name: "Fine Arts", test1: 16, test2: 17, exam: 40, total: 73, grade: "B", remark: "Good" },
      { name: "Basic Technology", test1: 14, test2: 15, exam: 32, total: 61, grade: "C", remark: "Credit" },
      { name: "Computer Studies", test1: 15, test2: 16, exam: 37, total: 68, grade: "C", remark: "Credit" },
      { name: "Basic Science", test1: 17, test2: 18, exam: 54, total: 90, grade: "A1", remark: "Excellent" },
      { name: "Civic Education", test1: 16, test2: 17, exam: 51, total: 84, grade:+ "A2", remark: "Very Good" },
      { name: "Literature", test1: 15, test2: 16, exam: 30, total: 61, grade: "C", remark: "Credit" },
      { name: "Business Studies", test1: 14, test2: 15, exam: 50, total: 79, grade: "B", remark: "Good" },
  ...
  "Monday Fauziya": {
    ...
    average: "59.87",
    subjects: [
      { name: "English Language", test1: 15, test2: 16, exam: 35, total: 66, grade: "C", remark: "Credit" },
      { name: "Mathematics", test1: 14, test2: 15, exam: 21, total: 50, grade: "P", remark: "Pass" },
      { name: "Social Studies", test1: 15, test2: 16, exam: 25, total: 56, grade: "P", remark: "Pass" },
      { name: "History", test1: 14, test2: 15, exam: 21, total: 50, grade: "P", remark: "Pass" },
      { name: "Phonics", test1: 16, test2: 17, exam: 38, total: 71, grade: "B", remark: "Good" },
      { name: "Agricultural Science", test1: 16, test2: 17, exam: 15, total: 48, grade: "F", remark: "Needs improvement" },
      { name: "Home Economics", test1: 16, test2: 17, exam: 15, total: 48, grade: "A2", remark: "Very Good" },
      { name: "Music", test1: 17, test2: 18, exam: 30, total: 65, grade: "C", remark: "Credit" },
      { name: "Fine Arts", test1: 15, test2: 16, exam: 20, total: 51, grade: "P", remark: "Pass" },
      { name: "Basic Technology", test1: 13, test2: 14, exam: 23, total: 50, grade: "P", remark: "Pass" },
      { name: "Computer Studies", test1: 14, test2: 15, exam: 37, total: 66, grade: "C", remark: "Credit" },
      { name: "Basic Science", test1: 16, test2: 17, exam: 30, total: 63, grade: "C", remark: "Credit" },
      { name: "Civic Education", test1: 15, test2: 16, exam: 24, total: 55, grade: "P", remark: "Pass" },
      { name: "Literature", test1: 20, test2: 20, exam: 31, total: 71, grade: "B", remark: "Good" },
      { name: "Business Studies", test1: 15, test2: 15, exam: 21, total: 51, grade: "P", remark: "Pass" },
      { name: "Christian Religious Studies", test1: 20, test2: 20, exam: 40, total: 80, grade: "B", remark: "Very Good" }
    ],
    formTeacherRemark: "Little bit low. but Keep working hard!",
    principalRemark: "Good work. Continue to improve!",
    nextTermBegins: "January 5, 2026"
  },
  ...
  "Stanley Favour": {
    ...
    average: "71",
    subjects: [
      { name: "Mathematics", test1: 15, test2: 20, exam: 30, total: 65, grade: "C", remark: "Credit" },
      { name: "English Language", test1: 20, test2: 20, exam: 43, total: 83, grade: "A2", remark: "Very Good" },
      { name: "Further Mathematics", test1: 15, test2: 20, exam: 25, total: 59, grade: "D", remark: "Pass" },
      { name: "Biology", test1: 15, test2: 19, exam: 36, total: 70, grade: "B", remark: "Good" },
      { name: "Physics", test1: 16, test2: 18, exam: 35, total: 69, grade: "C", remark: "Credit" },
      { name: "Chemistry", test1: 17, test2: 20, exam: 27, total: 64, grade: "C", remark: "Credit" },
      { name: "Economics", test1: 20, test2: 20, exam: 30, total: 70, grade: "B", remark: "Good" },
      { name: "Computer Studies", test1: 19, test2: 20, exam: 36, total: 75, grade: "B", remark: "Good" },
      { name: "Civic Education", test1: 17, test2: 18, exam: 55, total: 90, grade: "A1", remark: "Excellent" },
      { name: "Food and Nutrition", test1: 17, test2: 17, exam: 16, total: 50, grade: "D", remark: "Pass" },
      { name: "Agricultural Science", test1: 18, test2: 19, exam: 20, total: 57, grade: "D", remark: "Pass" },
      { name: "Marketing", test1: 20, test2: 20, exam: 60, total: 100, grade: "A1", remark: "Excellent" }
    ],
    formTeacherRemark: "Favour has an improvement seriously!",
    principalRemark: "Excellent performance. A model student. Well done!",
    nextTermBegins: "January 5, 2026"
  }
};
